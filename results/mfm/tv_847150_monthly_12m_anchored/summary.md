...
12m trailing loadings, k=r=4, $B levels; months aligned to per-era constant anchors (Procrustes), no chained matching. In-sample R^2 0.986; mean within-era loading step 0.074 (chained version: see ../tv_ai_compute_monthly_12m).
