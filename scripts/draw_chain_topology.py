...
def main():
    ...
    foot = ("Two input branches, one output line. Materials (pink) -- silicon, chemicals, "
            ...
            "Korean memory is shipped to Taiwan (a flow the data shows) and joins the "
            "processors at packaging there; the joining step itself happens inside Taiwan, so "
            "it leaves no trade record. Chip design earns as a service and crosses no border. "
