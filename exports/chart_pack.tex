...
\chartpage{When the network changed shape}{The line measures how much the time-varying export groupings moved month-to-month. We see stability until Aug 2023 (AI demand), Oct 2024 (memory export controls were signaled), and Sep 2025 (Nvidia's GB300 ramp, visible here as a Mexican assembly surge; China's turn to domestic chips is contemporaneous but does not move these codes).}{../results/mfm/tvmfm/chn_hkg_bloc/ai_compute/drift.pdf}
