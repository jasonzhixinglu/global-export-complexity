...
\chartpage{The same model as a picture}{Each period's trade matrix is summarized by which countries export alike, which import alike, and a small table of dollars between those hubs. Hub membership is the slow-moving structure; the small table is the fast part.}{mfm_schematic.pdf}
