...
\chartpage{When the network changed shape}{The line measures how much the time-varying export groupings moved month-to-month. We see stability until Aug 2023 (AI demand), Oct 2024 (memory export controls were signaled), and Sep 2025, where the hubs simplify to roughly one country each; no policy event is established for that last break.}{../results/mfm/tvmfm/chn_hkg_bloc/ai_compute/drift.pdf}
