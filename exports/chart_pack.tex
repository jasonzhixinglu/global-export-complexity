...
\begin{center}
  ...
  \begin{minipage}{\ifmobile 0.92\else 0.80\fi\linewidth}\centering
    ...
    Using data from UN Comtrade + TDM + Trade Atlas, construct a bilateral monthly panel of HS6 trade flows relevant for the AI-compute supply chain (60 HS6 codes, 2017-01 to 2026-04). 
  \end{minipage}
  \vspace{22pt}
...
\sectionpage{1. The chain as HS6 trade flows}{2024 annual trade flows. Upstream stages come from Trade Atlas, the compute stages from our own monthly panel. China and Hong Kong are counted as one trade bloc (CHK) throughout}

\chartpage{Topography of the supply chain}{Two upstream inputs feed chip fabrication: capital equipment fixed costs in orange are used to build chip fabs, raw materials and wafer variable costs are used per chip. Green represents the chip fabrication. Chips feed downstream assembly into AI servers. Circle size in proportion with the log of 2024 USD trade value.}{chain_topology.pdf}
...
\sectionpage{2. The chain in stages}{One page per stage: exporters on the left, importers on the right, with the factor model's country groupings in between. The groupings fit the 2024 flows closely (R-squared 0.95 to 0.99). Stages 1 to 5 are Trade Atlas annual data, stages 6 to 8 our monthly panel.}
...
\chartpage{Stage 3 -- lithography and optics inputs}{Lenses, optical elements, electron microscopes and wafer inspection tools. Japan, the China bloc, Germany and the United States lead the export side.}{hubs_nnf/supply_chain_3_litho_optics_nnf_hubs_2024.pdf}
...
\chartpage{Stage 6 -- parts and GPU modules (847330)}{The China bloc exports the most by value (30B in 2024), ahead of the United States and Korea; the United States is the largest buyer (31B), then the China bloc and Mexico.}{hubs_nnf/supply_chain_6_parts_nnf_hubs_2024.pdf}

\chartpage{Stage 7 -- baseboards (847180)}{The most concentrated stage: Taiwan exports 58B of the total in 2024, five times the next exporter, and the United States takes 39B of it.}{hubs_nnf/supply_chain_7_baseboards_nnf_hubs_2024.pdf}

\chartpage{Stage 8 -- AI servers (847150)}{Mexico (26B) and Taiwan (23B) assemble and ship; the United States buys 46B, about a third of world imports in this code.}{hubs_nnf/supply_chain_8_servers_nnf_hubs_2024.pdf}
