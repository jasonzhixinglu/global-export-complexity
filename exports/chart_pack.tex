...
\sectionpage{3. The time-varying MFM -- AI-compute only}{This section looks at the three downstream AI-compute HS6 codes jointly (parts/GPU modules, baseboards, AI servers), and estimates a time-varying MFM on monthly trade from 2017.}

\chartpage{When the network changed shape}{The line measures how much the time-varying export groupings moved month-to-month. We see stability until Aug 2023 (AI demand), Oct 2024 (memory export controls were signaled), and Sep 2025, where the hubs simplify to roughly one country each. That last break is a Mexican assembly surge: Mexico to the US rises 56 percent and Taiwan to Mexico more than doubles, coinciding with Nvidia's GB300 production ramp.}{../results/mfm/tvmfm/chn_hkg_bloc/ai_compute/drift.pdf}
