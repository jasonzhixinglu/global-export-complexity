...
- **Corridors** — bilateral origin → destination flows across PCI (top 50 + Rest of world).
...
`anchors`, `pci_products`), generated from the project pipeline:
...
Regenerate whenever the surfaces change, then commit the updated JSON.
